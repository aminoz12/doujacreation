...
const COPY = {
  fr: { title: 'Découvrez Nos Produits', empty: 'Aucun produit pour le moment.', viewAll: 'Voir Tout' },
  en: { title: 'Discover Our Products', empty: 'No products yet.', viewAll: 'View All' },
}
    ...
    <section className="section-padding bg-luxury-ivory">
      <div className="container-luxury">
        ...
        {loading ? (
          ...
          <p className="text-center text-luxury-black/60 font-sans text-sm">{c.empty}</p>
        )}
