    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 mt-1">Manage product tags for filtering</p>
        </div>
        <Link
          href="/admin/tags/new"
          ...
          {filteredTags.map((tag, index) => (
            ...
            >
              <div className="flex items-start justify-between">
                <div>
                  <h3 className="font-medium text-white">{tag.name_en}</h3>
                  <p className="text-sm text-slate-400">{tag.name_fr}</p>
