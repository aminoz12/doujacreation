  ...
  try {
    ...
    const { data: product, error: productError } = await supabaseAdmin
      ...
      .update({
        ...
        size_guide_en: body.size_guide_en || null,
        size_guide_fr: body.size_guide_fr || null,
        fabric_care_en: body.fabric_care_en || null,
        fabric_care_fr: body.fabric_care_fr || null,
